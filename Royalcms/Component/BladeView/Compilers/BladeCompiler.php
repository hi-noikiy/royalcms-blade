<?php namespace Royalcms\Component\View\Compilers;
...
class BladeCompiler extends Compiler implements CompilerInterface {
	...
	protected function compileLanguage($value)
	{
		...
		$value = preg_replace($pattern, '$1<?php echo \Royalcms\Component\Support\Facades\Lang::get$2; ?>', $value);

		$pattern = $this->createMatcher('choice');

		return preg_replace($pattern, '$1<?php echo \Royalcms\Component\Support\Facades\Lang::choice$2; ?>', $value);
	}
