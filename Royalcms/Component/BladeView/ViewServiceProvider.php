...
class ViewServiceProvider extends ServiceProvider {
	...
	public function registerEngineResolver()
	{
		...
		$this->royalcms->bindShared('view.engine.resolver', function($app) use ($me)
		{
	...
	public function registerBladeEngine($resolver)
	{
		...
		$royalcms->bindShared('blade.compiler', function($royalcms)
		{
			$cache = $royalcms['path.storage'].'/views';
		...
		{
			return new CompilerEngine($royalcms['blade.compiler'], $royalcms['files']);
		});
	}
